...
export default function About() {
  return (
    <>
      ...
      />
      <div className="w-full h-screen absolute -translate-x-9 -translate-y-[12%]">
        <RenderModel>
          <Mushroom />
        </RenderModel>
      </div>
      ...
      <div className="relative w-full h-screen flex flex-col items-center justify-center">
        <div className="absolute flex flex-col items-center text-center top-[4%] left-1/2 -translate-x-1/2">
          <h1 className="font-bold text-9xl text-accent">Michelle</h1>
